...
public class DesplegarUsu extends JFrame{
    private JLabel fondo;
    private JTable jTTablita;
    private  JScrollPane jScrollPane1;
    private ArrayDatosAlumnos Alumnos;
    private JButton volver;
    ArrayList<DatosAlumno> tabla=new ArrayList<DatosAlumno>();
    ...
    public void iniciarComponentes() {
        ...
        jTTablita.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String [] {
                        "Num Boleta", "Nombre", "Correo", "Grupo", "Sexo"
                }
        ));
        ...
        jTTablita.setModel(new javax.swing.table.DefaultTableModel(
                matris,
                new String [] {
                        "Boleta", "Nombre", "Correo", "Grupo", "Sexo"
                }
        ));
        ...
        add(fondo);
        ImageIcon icon2 = new ImageIcon("src/ActividadIntegradora/Imagenes/MOR.jpg");

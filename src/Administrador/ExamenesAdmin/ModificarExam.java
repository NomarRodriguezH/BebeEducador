...
public final class ModificarExam extends JFrame implements ActionListener {
    ...
    public ModificarExam(String titulo){
        setLayout(null);
        setSize(1100,850);
    ...
    public void iniciarComponentes(String titulo){
        ...
        add(jlRespuestaCo1);
        txtRespuestaCo1 = new JTextField(exa.getRespueCorrec1());
        ...
        add(jlRespuestaCo2);
        txtRespuestaCo2 = new JTextField(exa.getRespueCorrec2());
        ...
        add(jlRespuestaCo3);
        txtRespuestaCo3 = new JTextField(exa.getRespueCorrec3());
        ...
        add(jlRespuestaCo4);
        txtRespuestaCo4 = new JTextField(exa.getRespueCorrec4());
        ...
        add(jlRespuestaCo5);
        txtRespuestaCo5 = new JTextField(exa.getRespueCorrec5());
        ...
        add(jlRespuestaCo6);
        txtRespuestaCo6 = new JTextField(exa.getRespueCorrec6());
        ...
        add(jlRespuestaCo7);
        txtRespuestaCo7 = new JTextField(exa.getRespueCorrec7());
        ...
        add(jlRespuestaCo8);
        txtRespuestaCo8 = new JTextField(exa.getRespueCorrec8());
        ...
        add(jlRespuestaCo9);
        txtRespuestaCo9 = new JTextField(exa.getRespueCorrec9());
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getActionCommand().equals("Guardar Cambios")){
            ...
            exam.setTitulo(jlTitulo.getText());
            ...
            if(agregar == true) {
                examen.cambiar(examen.traePosicion(exam.getTitulo()), exam);
                JOptionPane.showMessageDialog(null, "Examen Modifiado");
                examen.actualizar();
            }
        }
